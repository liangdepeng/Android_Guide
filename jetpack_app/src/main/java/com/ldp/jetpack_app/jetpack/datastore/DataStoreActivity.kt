    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mViewBinding.saveSyncBtn.setOnClickListener {
            runBlocking {
                ...
                DataStoreUtil.asyncSave(
                    stringPreferencesKey("testKey1"),
                    "同步保存成功 :" + mViewBinding.et.text.toString()
                )
        ...
        mViewBinding.saveAsyncBtn.setOnClickListener {
            lifecycleScope.launch {
                // 此种方法 协程异步 保存
                DataStoreUtil.asyncSave(
                    stringPreferencesKey("testKey2"),
                    "异步保存成功 :" + mViewBinding.et.text.toString()
                )
